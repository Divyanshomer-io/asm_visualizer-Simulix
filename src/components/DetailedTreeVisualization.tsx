...
import { ChevronLeft, ChevronRight, TreePine, Target, Loader2, BarChart3, TrendingUp, Activity, Info } from 'lucide-react';
...
const DetailedTreeVisualization: React.FC<DetailedTreeVisualizationProps> = ({
  ...
  return (
    <TooltipProvider>
      <Card className="glass-panel border-white/10 relative plot-container">
        {/* Loading Overlay */}
        {isLoadingTree && (
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle>Decision Tree #{selectedTreeIndex} Analysis</CardTitle>
            </div>
            
            {/* Navigation Controls with Tooltip */}
            <div className="flex items-center gap-4">
              <Tooltip>
                ...
                <TooltipContent className="tooltip-content max-w-[280px]">
                  <div>
                    <strong>Tree Navigation</strong><br />
                    Browse through individual trees in the Random Forest (1-{totalTrees}). Each tree sees different data samples and features, creating ensemble diversity.
                  </div>
                </TooltipContent>
              </Tooltip>
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="tooltip-content max-w-[280px]">
                    <div>
                      ...
                      Individual tree analysis from the Random Forest ensemble.
                      <br /><br />
                      <strong>Decision Nodes:</strong> Internal splits<br />
                      <strong>Leaf Nodes:</strong> Final predictions<br />
                      <strong>Max Depth:</strong> Longest decision path
                    </div>
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-green-400 text-lg font-semibold">Sample Decision Path</h4>
                </div>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Info className="h-4 w-4 text-green-400 cursor-help info-icon" />
                  </TooltipTrigger>
                  <TooltipContent className="tooltip-content max-w-[280px]">
                    <div>
                      <strong>Decision Path</strong><br />
                      Step-by-step decisions this tree makes for a sample case.
                      <br /><br />
                      Each step shows:<br />
                      • Feature name (e.g., concavity_error)<br />
                      • Threshold value<br />
                      • Direction of split (≤ or &gt;)
                    </div>
                  </TooltipContent>
                </Tooltip>
              </div>
                ...
                {treeData.decision_path.length > 0 && (
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      className="flex-1 bg-green-500/10 border border-green-500/30 text-green-400 hover:bg-green-500/20 transition-all"
                      variant="outline"
                    >
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="tooltip-content max-w-[280px]">
                        <div>
                          <strong>Tree Prediction</strong><br />
                          Shows this individual tree's classification for the sample, including confidence level and reasoning based on the decision path taken.
                        </div>
                      </TooltipContent>
                    </Tooltip>
                  </div>
