    ...
    <div className="min-h-screen bg-background text-foreground antialiased overflow-x-hidden">
      ...
      <main className="container px-4 md:px-8 py-16">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="relative">
            {/* Background Effects */}
            <div className="absolute inset-0 bg-gradient-to-br from-accent/5 via-blue-500/5 to-purple-500/5 rounded-3xl blur-3xl"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-cyan-500/5 to-transparent rounded-3xl"></div>
            
            {/* Animated Particles */}
            <div className="absolute inset-0 overflow-hidden rounded-3xl">
              <div className="absolute top-16 left-16 w-2 h-2 bg-accent/40 rounded-full animate-pulse"></div>
              <div className="absolute top-24 right-24 w-1 h-1 bg-blue-400/50 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }}></div>
              <div className="absolute bottom-24 left-24 w-1.5 h-1.5 bg-purple-400/40 rounded-full animate-pulse" style={{ animationDelay: '2.5s' }}></div>
              <div className="absolute bottom-16 right-16 w-1 h-1 bg-cyan-400/50 rounded-full animate-pulse" style={{ animationDelay: '0.8s' }}></div>
              <div className="absolute top-1/2 left-8 w-1 h-1 bg-green-400/40 rounded-full animate-pulse" style={{ animationDelay: '3s' }}></div>
            </div>
            ...
            <div className="relative text-center space-y-8 py-20 px-8">
              ...
              <div className="inline-flex items-center gap-3 px-8 py-4 glass-panel rounded-full mb-6 group hover:scale-105 transition-all duration-500 border-2 border-white/10 hover:border-accent/30">
                <div className="relative">
                  <ChartLine className="h-7 w-7 text-accent group-hover:scale-110 transition-transform duration-300" />
                ...
                <span className="text-xl font-bold bg-gradient-to-r from-accent via-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  All Visualizations
                </span>
              </div>
              ...
              <div className="space-y-6">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight">
                  <span className="block bg-gradient-to-r from-white via-accent to-cyan-400 bg-clip-text text-transparent drop-shadow-lg">
                    Complete
                  </span>
              ...
              <div className="flex justify-center gap-8 pt-4">
                ...
                <div className="w-16 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent rounded-full" style={{ animationDelay: '0.5s' }}></div>
                <div className="w-12 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent rounded-full" style={{ animationDelay: '1s' }}></div>
                <div className="w-20 h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent rounded-full" style={{ animationDelay: '1.5s' }}></div>
              </div>
            </div>
          </div>
