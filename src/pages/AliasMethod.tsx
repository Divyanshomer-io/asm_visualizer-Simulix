      ...
      <main className="container px-4 md:px-8 pb-16">
        <div className="glass-panel p-6 rounded-xl space-y-6">
          <div className="space-y-4">
            <h2 className="text-2xl font-medium">The Magic of Weighted Chance: Understanding the Alias Method</h2>
            ...
            <h3 className="text-xl font-medium mt-6">What is the Alias Method?</h3>
            <p className="opacity-80">
            ...
            <h3 className="text-xl font-medium mt-6">The Secret: Two Special Tables</h3>
            <p className="opacity-80">
            ...
            <h3 className="text-xl font-medium mt-6">How to Play: Rolling the Weighted Dice (Sampling)</h3>
            <p className="opacity-80">
              Once the tables are ready, rolling our weighted dice is incredibly simple and fast:
            </p>
            <ol className="list-decimal pl-6 opacity-80 space-y-2">
          ...
          <div className="glass-panel p-6 rounded-lg space-y-4">
            <h3 className="text-lg font-medium">How to Use This Simulator</h3>
            
            <ul className="list-disc pl-6 opacity-80 space-y-3">
              <li>
